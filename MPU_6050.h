...
#define	MPU6050_RA_SMPLRT_DIV		0x19	//SAMPLE RATE DIVIDER, value: 0x07 (125Hz)
#define	MPU6050_RA_CONFIG			0x1A	//CONFIGURATION, value: 0x06 (5Hz)
#define	MPU6050_RA_GYRO_CONFIG		0x1B	//GYROSCOPE CONFIGURATION, value: 0x18 (2000deg/s)
#define	MPU6050_RA_ACCEL_CONFIG		0x1C	//ACCELEROMETER CONFIGURATION, value: 0x01 (2G,5Hz)
...
#define	MPU6050_RA_ACCEL_XOUT_H	0x3B	//0
#define	MPU6050_RA_ACCEL_XOUT_L	0x3C	//1
#define	MPU6050_RA_ACCEL_YOUT_H	0x3D	//2
#define	MPU6050_RA_ACCEL_YOUT_L	0x3E	//3
#define	MPU6050_RA_ACCEL_ZOUT_H	0x3F	//4
#define	MPU6050_RA_ACCEL_ZOUT_L	0x40	//5

#define	MPU6050_RA_TEMP_OUT_H	0x41	//6
#define	MPU6050_RA_TEMP_OUT_L	0x42	//7

#define	MPU6050_RA_GYRO_XOUT_H	0x43	//8
#define	MPU6050_RA_GYRO_XOUT_L	0x44	//9
#define	MPU6050_RA_GYRO_YOUT_H	0x45	//10
#define	MPU6050_RA_GYRO_YOUT_L	0x46	//11
#define	MPU6050_RA_GYRO_ZOUT_H	0x47	//12
#define	MPU6050_RA_GYRO_ZOUT_L	0x48	//13
...
#define	MPU6050_RA_PWR_MGMT_1		0x6B	//POWER MANAGEMENT 1,value:0x00
...
#define	MPU6050_RA_WHO_AM_I			0x75	//WHO AM I(value 0x68)
